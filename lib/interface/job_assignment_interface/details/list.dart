...
class _JobAssignmentListWidgetState extends State<JobAssignmentListWidget> {
  ...
  onSortColum(int columnIndex, bool ascending) {
    switch (columnIndex) {
      ...
      case 3:
        if (ascending) {
          widget.jobItemAssignments
              .sort((a, b) => (a.shiftSchedule.weigher.firstName + " " + a.shiftSchedule.weigher.lastName).compareTo(b.shiftSchedule.weigher.firstName + " " + b.shiftSchedule.weigher.lastName));
        } else {
          widget.jobItemAssignments
              .sort((a, b) => (b.shiftSchedule.weigher.firstName + " " + b.shiftSchedule.weigher.lastName).compareTo(a.shiftSchedule.weigher.firstName + " " + a.shiftSchedule.weigher.lastName));
        }
        break;
      case 4:
        if (ascending) {

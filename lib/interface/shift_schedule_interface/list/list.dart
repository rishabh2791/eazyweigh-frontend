...
class _ShiftScheduleListState extends State<ShiftScheduleList> {
  ...
  onSortColum(int columnIndex, bool ascending) {
    switch (columnIndex) {
      ...
      case 2:
        if (ascending) {
          widget.shiftSchedules.sort((a, b) => (a.weigher.firstName + " " + a.weigher.lastName).compareTo((b.weigher.firstName + " " + b.weigher.lastName)));
        } else {
          widget.shiftSchedules.sort((a, b) => (b.weigher.firstName + " " + b.weigher.lastName).compareTo((a.weigher.firstName + " " + a.weigher.lastName)));
        }
        break;
      default:
        break;

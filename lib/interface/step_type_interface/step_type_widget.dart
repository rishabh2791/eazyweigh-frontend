...
import 'package:eazyweigh/interface/step_type_interface/details/step_type_details_widget.dart';
                ...
                children: [
                  ...
                  UserActionButton(
                    callback: () {
                      Navigator.of(context).pushReplacement(
                        CupertinoPageRoute(
                          builder: (BuildContext context) => const StepTypeDetailsWidget(),
                        ),
                      );
                    },
                    icon: Icons.list,
                  ...
                  UserActionButton(
                    callback: () {
                      Navigator.of(context).pushReplacement(
                        CupertinoPageRoute(
                          builder: (BuildContext context) => const StepTypeUpdateWidget(),
                        ),
                      );
                    },
                    icon: Icons.update,

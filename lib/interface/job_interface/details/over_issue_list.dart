    ...
    switch (columnIndex) {
      ...
      case 6:
        if (ascending) {
          ...
          widget.overIssues.sort((a, b) => (b.overIssue.updatedBy.firstName + " " + b.overIssue.updatedBy.lastName)
              .toString()
              .compareTo((a.overIssue.updatedBy.firstName + " " + a.overIssue.updatedBy.lastName).toString()));
        }
        break;
      default:
        break;

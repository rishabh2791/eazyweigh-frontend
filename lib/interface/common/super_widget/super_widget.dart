...
import 'package:eazyweigh/interface/common/super_widget/super_menu_widget.dart' as menu;
...
class _SuperPageState extends State<SuperPage> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    ...
    scaleAnimation = Tween<double>(begin: 1, end: 0.8).animate(animationController);
        ...
        builder: (_, theme, child) {
          return BaseWidget(
            builder: (context, sizeInformation) {
              return Scaffold(
                backgroundColor: themeChanged.value ? backgroundColor : foregroundColor,
                body: Stack(
                  children: [
                    ...
                    isLoggedIn
                        ? Positioned(
                            ...
                            child: Row(
                              children: [
                                Tooltip(
                                  message: themeChanged.value ? "Switch to Light Theme" : "Switch to Dark Theme",
                                  child: InkWell(
                                    onTap: () {
                                      setState(() {
                                    ...
                                    child: Container(
                                      ...
                                      child: Icon(
                                        themeChanged.value ? Icons.nightlight : Icons.nightlight_outlined,
                                ...
                                InkWell(
                                  ...
                                  child: Container(
                                    ...
                                    child: Text(
                                      menuItemSelected.toUpperCase().replaceAll("_", " "),
                                      style: TextStyle(
